...
HD_PWD='D:/RCLabProjects/kaggo_stone/kaggo_stone.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kagge.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kagge.tcl
